...
- It's highly suggested you put your hub into "Offline" mode by performing a [stack update](hubs-cloud-aws-updating-the-stack-ko.md) before doing so to limit the risk of data being missed.
