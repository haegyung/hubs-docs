...
1. **(Account management) Create accounts for approved emails**
   1. Admin Panel > Accounts menu - [_NetworkError?_](hubs-cloud-aws-troubleshooting-ko.md#in-my-hubs-admin-panel-i-see-networkerror-or-not-found-page-or-no-data-populates-in-any-of-the-admin-menus)
...
3. **Remove account creation for non-admins**
   1. Admin Panel > Setup: App Settings - [_Not Found page?_](hubs-cloud-aws-troubleshooting-ko.md#in-my-hubs-admin-panel-i-see-networkerror-or-not-found-page-or-no-data-populates-in-any-of-the-admin-menus)
...
[Learn more about the Discord bot here](hubs-discord-bot-ko.md)

[Enable the Discord bot for your Hubs Cloud instance](hubs-cloud-discord-bot-ko.md)

## Room Access Settings

Individual rooms can also limit access via [Room Access Settings](hubs-room-settings-ko.md#room-access).
