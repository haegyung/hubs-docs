...
To get them running and take them "Online" follow the [Update the Stack Guide](hubs-cloud-aws-updating-the-stack-ko.md). When you want to take them "Offline" again, follow the same process and select "Offline".
